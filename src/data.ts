...
GPT API가 처음 등장하던 시기에 AI 기술을 독학으로 익혀 실제 서비스에 적용했고,<br/>
AI Agents Master 챌린지에서 6주간 3개의 AI 프레임워크를 습득해 Agent를 완성했습니다.<br/>
낯선 기술 앞에서도 두려워하지 않고 끝까지 해내는 도전을 멈추지 않습니다.<br/><br/>

프론트엔드를 넘어 API 설계, 배포 운영까지 엔드투엔드로 시스템을 바라보며<br/>
시스템 통합과 프로세스 최적화를 전문성의 핵심 영역으로 삼고 있습니다.<br/><br/>

앞으로도 끊임없이 도전하며 성장하는 개발자로 남겠습니다.`
...
export const workExperience = [
  ...
  // },
  {
    ...
    {
      title: 'SBS 숏폼 콘텐츠 플레이어 개발',
      role: 'FE',
      description: `
      Vanilla JS + Custom Elements 기반 숏폼 콘텐츠 플레이어 단독 개발
      재사용 가능한 커스텀 컴포넌트 설계로 유지보수성 및 확장성 확보
      `,
      date: '2024.03 ~ 2024.06',
      skills: ['Vanilla.js', 'Custom Elements', 'JavaScript'],
    },],
  },
]
