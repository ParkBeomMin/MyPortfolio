  ...
  projects: [
    {
      ...
      needs: {
        ...
        title: "NEEDS",
        contents: [
          "비로그인/입사제안N인 경우 기업분석리포트의 열람제한되는 영역 로직을 변경 적용",
        ],
      },
      problem: {
        id: uuidv4(),
  ...
  aboutMe: [
    {
      ...
      <br>안드로이드 앱 개발로 시작한 개발자의 꿈이 웹 개발로 이어지며
      많은 변화가 있었지만, <b>'유저가 만족할 수 있는 서비스'</b>를 만들고자 하는 마음은 언제나 동일합니다.
      고객 중심의 기획자, 퍼블리셔 분들과 같은 마음으로 프로젝트에 임하며 '소통형' 웹 개발자라고 불리고 있습니다.
      <br><br>
      저는 기존 구조를 다양한 방법으로 활용하며 문제를 해결하는 것을 좋아합니다.
      <br>안될 이유보다 될 이유를 찾는 자세로
      보다 효율적인 방법을 찾아 코드와 구조를 설계하고 있습니다.
      <br><br>
      데이터 흐름과 상태 관리, 성능 최적화, 디자인 패턴, 그리고 리팩토링에 관심이 있으며
