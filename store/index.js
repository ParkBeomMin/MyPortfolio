  ...
  aboutMe: [
    {
      ...
      bio: `안녕하세요, 박범민입니다.
      <br><br>
      저는 기존의 것을 활용하여 다양한 방법으로 문제를 해결해나가는 것을 좋아합니다.
      <br><br>
      안될 이유보다 될 이유를 찾아나가는 방향으로 생각합니다.
      <br><br>
      웹 개발자로 일하고 있고, 효율적으로 문제를 해결하기 위한 코드와 구조를 고민합니다.
      <br><br>
      데이터의 흐름과 상태 관리, 성능 최적화, 디자인 패턴, 리팩토링에 관심이 있습니다.
      <br><br>
      팀 내 DX(Developer Experience) 향상을 위해 노력하고 있습니다.
      <br><br>
      안드로이드 앱 개발로 개발자의 꿈을 갖게 되었지만, 어쩌다보니 웹 개발자로의 성장을 꿈꾸게 되었습니다.
      <br><br>
      사용자들에게 만족감을 주는 서비스를 좋아합니다.`,
    },
  ],
